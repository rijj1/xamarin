    ...
    public class LiveStreamingActivity : RtcBaseActivity, IEventHandler, IDialogListCallBack/*, PixelCopy.IOnPixelCopyFinishedListener*/
    {
                    ...
                    default:
                        {
                            if (LiveStreamViewerObject != null)
                            {
                                GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, MAvatarBg, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
                                MAvatar.SetImageURI(Android.Net.Uri.Parse(LiveStreamViewerObject.Avater));
                            }
        ...
        private void InitStreamerInfo()
        {
            try
            {
                ...
                if (LiveStreamViewerObject != null)
                {
                    GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Avater, streamerAvatar, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
