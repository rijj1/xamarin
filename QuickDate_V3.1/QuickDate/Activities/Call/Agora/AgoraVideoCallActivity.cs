...
using QuickDate.Activities.Call.Agora.Tools;
    ...
    public class AgoraVideoCallActivity : AppCompatActivity
    {
        ...
        private void Load_userWhenCall()
        {
            try
            {
                ...
                //profile_picture
                GlideImageLoader.LoadImage(this, CallUserObject.Avater, UserImageView, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
